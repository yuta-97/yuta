...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "자사 제품 공통으로 사용하는 UI 컴포넌트 라이브러리를 구축하여 개발 속도를 향상시키고, 일관된 사용자 경험을 제공했습니다. 재사용 가능한 컴포넌트 설계로 중복 코드를 제거하고 유지보수성을 개선했습니다.",
    tags: ["디자인 시스템", "팀 생산성", "문서화"],
    link: "/project/clever-ui",
